...
const VER = 'kapital-v25';
const FILES = [
  './', './index.html', './manifest.webmanifest',
  './css/app.css?v=25',
  './js/util.js?v=25', './js/fx.js?v=25', './js/auth.js?v=25', './js/ics.js?v=25', './js/store.js?v=25', './js/calc.js?v=25',
  './js/views.js?v=25', './js/detail.js?v=25', './js/app.js?v=25',
