...
/* Собирает приложение в один HTML-файл: стили и скрипты встраиваются внутрь.
   node fuel/tools/build-standalone.js [--artifact путь]   */
...
JS[NAMES.indexOf('app')] = JS[NAMES.indexOf('app')].replace(
...
if (artifactIdx >= 0) {
  ...
  fs.writeFileSync(out, `<title>Топливо</title>\n${body}\n`);
